...
function findCell$1(universe, position) {
...
function dedupe(universe) {
  ...
  return map(function (param) {
              return findCell$1(universe, param);
            }, dedupedPositions);
}
...
function selectRow(universe, viewPort) {
  ...
  return map(function (param) {
              return findCell$1(universe, param);
                ...
                }, range(viewPort[/* xMin */0], viewPort[/* xMax */2])));
}
...
function viewCell(_, param) {
  ...
  return div$2(/* None */0, /* None */0, /* [] */0, /* :: */[
              text$$1(string_of_int(match[0]) + ("," + (string_of_int(match[1]) + stringCell(param[1])))),
              /* [] */0
            ]);
}
...
function viewRow(universe, viewPort) {
  ...
  return div$2(/* None */0, /* None */0, /* [] */0, map(function (param) {
                  return viewCell(cellSize, param);
                }, row));
}

function viewUniverse(viewPort, universe) {
  var rowsRange = range(viewPort[/* yMin */1], viewPort[/* yMax */3]);
  var rowViewPort = function (row) {
    return newViewPort(viewPort[/* xMin */0], row, viewPort[/* xMax */2], row, viewPort[/* cellSize */4]);
  };
  var rowsViewPort = map(rowViewPort, rowsRange);
  var rowsHtml = map(function (param) {
        return viewRow(universe, param);
      }, rowsViewPort);
  return div$2(/* None */0, /* None */0, /* [] */0, rowsHtml);
}
...
function putSprite(stage, position, param) {
  if (param) {
    var s = param[0];
    _2(Container[/* addChild */0], stage, /* Sprite */__(1, [s]));
    _2(Sprite[/* updatePosition */0], s, position);
    return /* () */0;
  } else {
...
function setup() {
  ...
  var maybeShip = map$4(function (prim) {
        return new PIXI.Sprite(prim);
      }, andThen(_1(Resources[/* texture */1], "spaceship.png"), maybePack));
...
function myMain() {
  return _2(Loader[/* load */3], setup, _2(Loader[/* onProgress */2], function (p) {
...
exports.putSprite = putSprite;
exports.setup = setup;
exports.myMain = myMain;
exports.init = init;

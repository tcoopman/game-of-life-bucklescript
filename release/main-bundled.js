...
function map$$1(f, a$$1) {
  if (a$$1) {
    return /* Some */[_1(f, a$$1[0])];
  } else {
    return /* None */0;
  }
}

function andThen(f, a$$1) {
  if (a$$1) {
    return _1(f, a$$1[0]);
  } else {
    return /* None */0;
...
function myMain() {
  return _2(Loader[/* load */3], setup, _2(Loader[/* onProgress */2], function (p$$1) {
                  console.log(string_of_float(p$$1));
                  return /* () */0;

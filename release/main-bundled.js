...
function textures(name, loader) {
  return null_undefined_to_opt(loader.textures[name]);
}
...
function foo(loader, _) {
  ...
  var background = map$$1(function (prim) {
        return new PIXI.Sprite(prim);
      }, _2(Loader[/* textures */1], "background.png", pack));
  var ship = map$$1(function (prim) {
        return new PIXI.Sprite(prim);
      }, _2(Loader[/* textures */1], "spaceship.png", pack));
...
function myMain() {
  ...
  loader.add(/* array */["space/space.json"]).on("progress", function (lp) {
        console.log(string_of_float(lp.progress));
        return /* () */0;
      });
